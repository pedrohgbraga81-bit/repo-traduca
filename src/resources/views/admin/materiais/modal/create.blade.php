    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0 fw-bold">Novo Material</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-lg-8">
                    <div class="card recent-card">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-file-circle-plus me-2 text-primary"></i>Cadastrar Material</h5>
                        </div>
                            ...
                            <form action="{{ route('admin.materiais.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="titulo_materiais" class="form-control @error('titulo_materiais') is-invalid @enderror"
                                               value="{{ old('titulo_materiais') }}" placeholder="Ex: Apostila de Inglês Básico">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="descricao_materiais" rows="3"
                                                  ...
                                                  placeholder="Descreva brevemente o conteúdo do material...">{{ old('descricao_materiais') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="nivel_material" class="form-select @error('nivel_material') is-invalid @enderror">
                                            <option value="">Selecione...</option>
                                            <option value="Básico"         {{ old('nivel_material') == 'Básico'         ? 'selected' : '' }}>Básico</option>
                                            <option value="Intermediário"  {{ old('nivel_material') == 'Intermediário'  ? 'selected' : '' }}>Intermediário</option>
                                            <option value="Avançado"       {{ old('nivel_material') == 'Avançado'       ? 'selected' : '' }}>Avançado</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="curso_materiais"
                                               ...
                                               value="{{ old('curso_materiais') }}" placeholder="Ex: Inglês, Espanhol...">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-text">Formatos aceitos: PDF, Word, PowerPoint, Excel, ZIP. Máximo 20 MB.</div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-save me-1"></i> Salvar Material
                                    </button>
                                </div>
