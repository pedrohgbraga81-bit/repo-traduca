...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .avatar-stack span:first-child  { margin-left: 0; background: #8e6a3e; }
        .avatar-stack span:nth-child(2) { background: #3e6a8e; }
        .avatar-stack span:nth-child(3) { background: var(--accent); }
        ...
        .link-esqueceu:hover { color: var(--ink); border-color: var(--ink); }
