    ...
    <div class="container">
        <div class="sobre-container">
            <div class="imagem-container">
                <img src="{{ asset('traduca/img/globo2.png') }}" alt="Professsor Caetano" class="img-perfil" width="335" height="745" loading="lazy" decoding="async">
            </div>
            ...
            <div class="texto-sobre">
                ...
                <div class="biografia-texto">
                    <p>
                        Atuo no setor corporativo e acadêmico desenvolvendo projetos educacionais, treinamentos e materiais didáticos. Já traduzi conteúdos educacionais, institucionais e publicitários para clientes como Mercedes-Benz e Enel, e trabalho como Tradutor Sênior de inglês e italiano.
